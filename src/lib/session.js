// /opt/ai-project/src/lib/session.js - 完全修复String ID版本
...
// 🔧 简化：直接使用正确的字段名，避免动态检测
async function getKnowledgeFieldName(prismaClient) {
  // 根据您的Prisma schema，正确的字段名是 'knowledges'
  return { knowledges: true };
}
